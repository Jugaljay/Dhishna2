...
import java.util.List;
 ...
 viewHolder.event1 = (TextView) cell.findViewById(R.id.event1);

//viewHolder.date = (TextView) cell.findViewById(R.id.title_date_label);

 viewHolder.event2 = (TextView) cell.findViewById(R.id.event2);
 ...
 viewHolder.price.setText(item.getBranch());

// viewHolder.time.setText(item.getTime());

 //viewHolder.date.setText(item.getDate());

viewHolder.event2.setText(item.getevent2());

 //viewHolder.toAddress.setText(item.getToAddress());

 //viewHolder.requestsCount.setText(String.valueOf(item.getRequestsCount()));

 viewHolder.event1.setText(item.getevent1());
